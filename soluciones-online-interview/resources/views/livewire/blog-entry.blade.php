<figure class="bg-[#333] w-[500px] h-[230px] flex flex-col rounded-lg p-2 text-white" >
    <p class="w-full block font-bold mb-1 " >{{$blogTitle}}</p>
    <div class="flex">
        ...
        <div class="w-[70%] " >
            ...
            <button wire:click="emitChat" class="bg-[#5f5f5f] py-2 px-4 rounded font-bold mt-2 hover:bg-indigo-500 transition-colors" >Chat</button>
        </div>
    </div>
</figure>
